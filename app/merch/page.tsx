  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background text-foreground">
        ...
        {/* Hero Banner */}
        <section className="relative pt-32 pb-20 px-6 overflow-hidden border-b border-border/30">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <h1 className="mt-4 font-serif text-5xl md:text-7xl lg:text-8xl tracking-tight text-foreground">
              O.W.P.I.L
              <br />
              <span className="text-primary italic">Merch</span>
            </h1>
            <p className="mt-6 max-w-xl mx-auto font-mono text-sm text-muted-foreground leading-relaxed">
              Wearable art. Limited runs. Each piece tells part of the story.
              Own a chapter of the journey.
            </p>
            <div className="mt-4 inline-flex items-center gap-2 font-mono text-xs text-muted-foreground/60">
        ...
        {/* Category Filter */}
        <section className="sticky top-16 z-30 bg-background/95 backdrop-blur-md border-b border-border/20 px-6 py-4">
          <div className="max-w-7xl mx-auto flex items-center gap-2 overflow-x-auto scrollbar-none">
            {categories.map(cat => (
              <button
                key={cat}
                onClick={() => setActiveCategory(cat)}
                className={`flex-shrink-0 px-5 py-2 font-mono text-xs tracking-[0.15em] uppercase border transition-all duration-300 ${
                  activeCategory === cat
        ...
        <section className="max-w-7xl mx-auto px-6 py-20">
              ...
              >
                ...
                >
                  ...
                  <div className="text-center px-8 select-none">
                    <p className="font-serif text-3xl font-bold text-white/10 group-hover:text-white/20 transition-all duration-700 tracking-widest">
                      O.W.P.I.L
                    </p>
                  ...
                  {/* Tag badge */}
                  <span className="absolute top-4 left-4 px-3 py-1 bg-primary text-background font-mono text-[10px] tracking-[0.15em] uppercase">
                    {product.tag}
                  </span>
                  ...
                  {!product.available && (
                    <div className="absolute inset-0 bg-background/70 flex items-center justify-center">
                      <span className="font-mono text-xs tracking-[0.2em] text-muted-foreground uppercase border border-border px-4 py-2">
                        Coming Soon
                      </span>
                    </div>
                  )}
                ...
                <div className="flex flex-col flex-1 p-6">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <span className="flex-shrink-0 font-mono text-lg text-primary font-bold">
                      ${product.price}
                    </span>
                  </div>
          ...
          {/* Bottom CTA */}
          <div className="mt-24 text-center border-t border-border/30 pt-16">
            ...
            <a
              ...
              className="mt-8 inline-block px-8 py-4 border border-primary/50 text-primary font-mono text-xs tracking-[0.2em] uppercase hover:bg-primary hover:text-background transition-all duration-300"
            >
              Get in touch
            </a>
          </div>
